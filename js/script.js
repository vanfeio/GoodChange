...
$(function () {
	...
	$("[id^= input][required]").keyup(function () {
		CheckRequire();
	});
	$("[id^= input][required]").change(function () {
		CheckRequire();
	});
	...
	function CheckRequire() {
		let send = true;
		try {
			$("[id^= input][required]").each(function (index) {
				const element = $("[id^= input][required]")[index];
				//console.log(element)
